...
setwd('/.mounts/labs/cpcgene/private/projects/GermlineSomaticAssociations/genome-wide/output/somatic_gwas/pancan/driver_rate_comparison')

date <- Sys.Date()
### DATA PROCESSING ###############################################################################
# read in aneuploidy file 
aneu <- read.csv('TCGA_aneuploidy.csv', as.is = TRUE, skip = 1)
...
create.densityplot(
	...
	filename = paste0(date, '_genome_doubling_densityplot.tiff'),
	resolution = 300,
