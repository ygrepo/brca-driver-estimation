...
calculate_median_est_incidence <- function() {
	...
	par <- expand.grid(cancer = c('BRCA','OV'), gene = c('BRCA1','BRCA2'), 
		mutation = c('snv','cna', 'deletion','amplification','indel'))#,'insertion', 'indelseg','amplificationseg','cnaseg','deletionseg'))
