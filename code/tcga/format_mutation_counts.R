...
write.table(
	cna_num,
	file = 'data/TCGA/TCGA_segments.tsv',
	sep = '\t',
	row.names = FALSE,
	quote = FALSE
	)
...
write.table(
	cna_bp,
	file = 'data/TCGA/TCGA_total_cna_bp.tsv',
	sep = '\t',
	row.names = FALSE,
	quote = FALSE
	)
...
write.table(
	del_dedup,
	file = 'data/TCGA/TCGA_segments_deletions_only.tsv',
	sep = '\t',
	row.names = FALSE,
	quote = FALSE
	)
...
write.table(
	ab_bp_dedup,
	file = 'data/TCGA_cna_deletion_bp.tsv',
	sep = '\t',
	row.names = FALSE,
	quote = FALSE
	)
...
write.table(
 	indel_df, 
 	file = 'data/TCGA/TCGA_indels_deletions_bp_only.tsv', 
 	sep = '\t', 
 	row.names = FALSE, 
 	quote = FALSE
 	)
...
write.table(
 	ins_df, 
 	file = 'data/TCGA/TCGA_indels_insertions_bp_only.tsv', 
 	sep = '\t', 
 	row.names = FALSE, 
 	quote = FALSE
 	)
